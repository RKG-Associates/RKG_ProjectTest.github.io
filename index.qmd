...
maine_income <- maine_income %>%
  mutate(
    income_dollars = dollar(estimate, accuracy = 1000),
    tooltip_text   = paste0(NAME, "<br/>Median income: ", income_dollars)
  )

maine_bounds <- sf::st_bbox(maine_income)
...
continuous_scale$labels <- scales::dollar(
  continuous_scale$breaks,
  accuracy = 1000
)
```
